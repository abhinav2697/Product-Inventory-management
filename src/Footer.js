    ...
    return (
        <div className="footer">
            <div className="footer__top">
                ...
                <div className="footer__infoList">
                    <ul>
                        ...
                        <li className="footer__infoLi">
                            <h5>About Shippify</h5>
                            <div className="footer__infoLinks">
                                <a>Shippify concept</a>
                                <a>This is Shippify</a>
                                <a>Sustainability</a>
                                <a>Ideas</a>
                                <a>Catalogue &amp; brochures</a>
                                <a>Campaigns</a>
                                <a>Working at Shippify</a>
                                <a>Press</a>
                                <a>Shippify news</a>
                            </div>
                        </li>
                        <li className="footer__infoLi">
                            <h5>Shopping at Shippify</h5>
                            <div className="footer__infoLinks">
                                <a>Opening hours</a>
                                <a>All stores</a>
                                <a>Offers</a>
                        ...
                        <li className="footer__infoLi">
                            <h5>Shippify Family &amp; Business</h5>
                            <div className="footer__infoLinks">
                                <a>Log in</a>
                                <a>Sign up</a>
                                <a>About Shippify Family</a>
                                <a>Benefits</a>
                                <a>Events</a>
                                <a>Shippify for Business</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div className="footer__bottom">
                <p>&copy; Inter Shippify Systems B.V. 1999-2020</p>
